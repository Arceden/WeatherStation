...
(function () {
  ...
  listen.newElements('user_create', document.getElementsByClassName("call_user_create"), new PopupHandler().newPopup(document.getElementById('user_create'))); // listen.newElements(
  //     'user_edit',
  ...
  listen.applyHandler('user_create'); // listen.applyHandler('user_edit');
